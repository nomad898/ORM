...
namespace DataModels
{
	...
	public partial class NorthwindDB : LinqToDB.Data.DataConnection
	{
		...
		public ITable<EmployeeCard>               EmployeeCards                { get { return this.GetTable<EmployeeCard>(); } }
	...
	public partial class Customer
	{
		...
		[Column,        Nullable] public DateTime? FoundationDate { get; set; } // date
	...
	public partial class Employee
	{
		...
		/// <summary>
		/// FK__EmployeeC__Emplo__7B5B524B_BackReference
		/// </summary>
		...
		public IEnumerable<EmployeeCard> EmployeeCEmplo7B5B524B { get; set; }
	...
	[Table(Schema="dbo", Name="EmployeeCards")]
	public partial class EmployeeCard
	{
		[PrimaryKey, NotNull] public int      CardID         { get; set; } // int
		[Column,     NotNull] public DateTime ExperationDate { get; set; } // date
		[Column,     NotNull] public string   CardHolder     { get; set; } // nvarchar(50)
		[Column,     NotNull] public int      EmployeeID     { get; set; } // int

		#region Associations

		/// <summary>
		/// FK__EmployeeC__Emplo__7B5B524B
		/// </summary>
		[Association(ThisKey="EmployeeID", OtherKey="EmployeeID", CanBeNull=false, Relationship=Relationship.ManyToOne, KeyName="FK__EmployeeC__Emplo__7B5B524B", BackReferenceName="EmployeeCEmplo7B5B524B")]
	...
	public partial class Region
	{
		...
		public IEnumerable<Territory> TerritoriesRegions { get; set; }
	...
	public partial class Territory
	{
		...
		/// </summary>
		[Association(ThisKey="RegionID", OtherKey="RegionID", CanBeNull=false, Relationship=Relationship.ManyToOne, KeyName="FK_Territories_Region", BackReferenceName="TerritoriesRegions")]
	...
	public static partial class TableExtensions
	{
		...
		public static EmployeeCard Find(this ITable<EmployeeCard> table, int CardID)
		{
			return table.FirstOrDefault(t =>
				t.CardID == CardID);
		}
